...
class Product(SoftDeleteModel):
    ...
    last_purchase_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="Prix d'achat", help_text="Dernier prix d'achat du produit")
